      ...
      <>
        <Collapse defaultActiveKey={['1','2','3']}>
          ...
          <Card className={styles.card} bordered={false}>
            ...
            <Row>
                <Col span={8}>
                  <Form.Item label="运行隔离" {...formItemLayout}>
                    {getFieldDecorator('operIsolation', {
                    })(
                      <Radio.Group>
                ...
                <Col span={8}>
                  <Form.Item label="需要RWP" {...formItemLayout}>
                    {getFieldDecorator('IsNeedRWP', {
                    })(
                      <Radio.Group>
                        <Radio value="1">是</Radio>
                        <Radio value="2">否</Radio>
              ...
              <Row>
                <Col span={8}>
                  <Form.Item label="质量计划" {...formItemLayout}>
                    {getFieldDecorator('EPlan', {
                    })(
                      <Radio.Group>
                        <Radio value="1">是</Radio>
                        <Radio value="2">否</Radio>
                ...
                <Col span={8}>
                  <Form.Item label="运行风险分析单" {...formItemLayout}>
              ...
              <Row>
                <Col span={8}>
                  <Form.Item label="维修后试验" {...formItemLayout}>
                    {getFieldDecorator('AfterrepairTest', {
                    })(
                      <Radio.Group>
                        <Radio value="1">是</Radio>
                        <Radio value="2">否</Radio>
                ...
                <Col span={8}>
                  <Form.Item label="修后试验类型" {...formItemLayout}>
                    {getFieldDecorator('afterRepairTestType', {
                    })(
                      <Select placeholder="请选择作业类型">
                        <Option value="1">B1类维修后试验</Option>
                        <Option value="2">B2类维修后试验</Option>
                        <Option value="3">B3类维修后试验</Option>
                      </Select>,
                    )}
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item label="修后试验负责人" {...formItemLayout}>
                      {getFieldDecorator('AfterRepairTestMan', {
                      })(<Input placeholder="请输入维修后试验负责人" type="treeSelect"/>)}
                  </Form.Item>
                </Col>
              </Row>
            </Form>
